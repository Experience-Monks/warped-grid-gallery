...
module.exports = function (config) {
    ...
    this.init = function (element, elementString, topLeft, topRight, bottomRight, bottomLeft) {
        ...
        //this._onOver = _that._onOver.bind(this);

        //console.log('_element: ',_element);

        //on(_element, 'mouseenter', this._onOver);
        /*on(_element, 'click', function(e){
            //alert('lskjfslj')
            console.log('e: ',e);
            console.log('slkjfds')
        });*/
        //on(_element, 'mouseenter',this._onOver = this._onOver.bind(this));
        /*on(_element, 'mouseleave',this._onOut = this._onOut.bind(this));
        on(_element, 'click',this._onClick = this._onClick.bind(this));*/
    ...
    this.destroy = function(){
        ...
        off(_element, 'mouseover',this._onOver);
        off(_element, 'mouseout',this._onOut);
        off(_element, 'click',this._onClick);
    };
